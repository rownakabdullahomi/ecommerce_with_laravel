...
<head>
    ...
    <!-- flaticon.css -->
    <link rel="stylesheet" href="{{ asset('ecommerce/css/flaticon.css')}}">
    <!-- jquery-ui.css -->
    <link rel="stylesheet" href="{{ asset('ecommerce/css/jquery-ui.css')}}">
    <!-- metisMenu.min.css -->
    <link rel="stylesheet" href="{{ asset('ecommerce/css/metisMenu.min.css')}}">
    <!-- swiper.min.css -->
    <link rel="stylesheet" href="{{ asset('ecommerce/css/swiper.min.css')}}">
    <!-- style css -->
    <link rel="stylesheet" href="{{ asset('ecommerce/css/styles.css')}}">
    <!-- responsive css -->
        ...
        <div class="fluid-container">
            <div class="row">
                <div class="col-lg-3 col-md-7 col-sm-6 col-6">
                    <div class="logo">
                        <a href="index.html">
                    <img src="{{ asset('ecommerce/images/logo.png') }}" alt="">
                    </a>
                    </div>
                </div>
                        ...
                        <li>
                            ...
                            <ul class="cart-wrap dropdown_style">
                                ...
                                @foreach (App\Models\Cart::where('generated_cart_id', Cookie::get('generated_cart_id'))->get() as $cart_item)
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img width="70px" src="{{ asset('uploads/product_photos') }}/{{ App\Models\Product::find($cart_item->product_id)->product_photo }}" alt="">
                                        </div>
                                        <div class="cart-content">
...
<!-- header-area end -->
    ...
    <script src="{{ asset('ecommerce/js/imagesloaded.pkgd.min.js') }}"></script>
    <!-- jquery.zoom.min.js -->
    <script src="{{ asset('ecommerce/js/jquery.zoom.min.js') }}"></script>
    <!-- countdown.js -->
    <script src="{{ asset('ecommerce/js/countdown.js') }}"></script>
    <!-- swiper.min.js -->
    <script src="{{ asset('ecommerce/js/swiper.min.js') }}"></script>
    <!-- metisMenu.min.js -->
    <script src="{{ asset('ecommerce/js/metisMenu.min.js') }}"></script>
    <!-- mailchimp.js -->
    <script src="{{ asset('ecommerce/js/mailchimp.js') }}"></script>
    <!-- jquery-ui.min.js -->
    <script src="{{ asset('ecommerce/js/jquery-ui.min.js') }}"></script>
    <!-- main js -->
    <script src="{{ asset('ecommerce/js/scripts.js') }}"></script>
</body>
